...
<body class="body">
    ...
    <div>
        ...
        <div style="height: 800px; width: 682px">
            ...
            <br />
            <br />
            <asp:SqlDataSource ID="tourSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:WWW71ConnectionString %>" DeleteCommand="DELETE FROM [tour] WHERE [tourId] = @tourId" InsertCommand="INSERT INTO [tour] ([place], [price], [flickrId], [youtubeId]) VALUES (@place, @price, @flickrId, @youtubeId)" SelectCommand="SELECT * FROM [tour]" UpdateCommand="UPDATE [tour] SET [place] = @place, [price] = @price, [flickrId] = @flickrId, [youtubeId] = @youtubeId WHERE [tourId] = @tourId">
                <DeleteParameters>
