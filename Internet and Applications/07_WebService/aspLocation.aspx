<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aspLocation.aspx.cs" Inherits="_07_WebService_aspLocation" %>
...
<body class="body">
    ...
    <div>
        ...
        <span class="title">ASP 一般網頁</span><br />
        <br />
        <br />
