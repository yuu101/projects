    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="auto-style1">
                <tr>
                    <td>
                        <asp:FormView ID="movieFormView" runat="server" DataSourceID="movieSqlDataSource">
                            <ItemTemplate>
                    ...
                    <td>
            <asp:RadioButtonList ID="movieRadioButtonList" runat="server" AutoPostBack="True" CssClass="subTitle" DataSourceID="movieSqlDataSource" DataTextField="movie" DataValueField="movieId" OnSelectedIndexChanged="movieRadioButtonList_SelectedIndexChanged">
            </asp:RadioButtonList>
                    </td>
                </tr>
            </table>
            ...
            <asp:SqlDataSource ID="gradeSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:WWW71ConnectionString %>" DeleteCommand="DELETE FROM [movieGrade] WHERE [gradeId] = @gradeId" InsertCommand="INSERT INTO [movieGrade] ([movieId], [grade], [gradeTime]) VALUES (@movieId, @grade, @gradeTime)" SelectCommand="SELECT * FROM [movieGrade]" UpdateCommand="UPDATE [movieGrade] SET [movieId] = @movieId, [grade] = @grade, [gradeTime] = @gradeTime WHERE [gradeId] = @gradeId">
                ...
                <InsertParameters>
                    ...
                    <asp:SessionParameter Name="gradeTime" SessionField="gradeTime" Type="DateTime" />
                </InsertParameters>
                <UpdateParameters>
