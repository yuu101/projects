...
<body class="body">
    ...
    <div>
        ...
        <div>
            ...
            <br />
            <br />
            <asp:SqlDataSource ID="pollSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:WWW71ConnectionString %>" SelectCommand="SELECT season.season, poll.pollId FROM poll INNER JOIN season ON poll.seasonId = season.seasonId ORDER BY poll.pollId DESC"></asp:SqlDataSource>
        </div>
