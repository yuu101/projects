<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ajaxVoteReal.aspx.cs" Inherits="_06_AJAX_vote_ajaxVoteReal" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">function onYouTubeIframeAPIReady() { }</script>
            ...
            <tr>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" OnLoad="UpdatePanel1_Load" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource4" DataTextField="title" DataValueField="beerId" OnSelectedIndexChanged="RadioButtonList2_SelectedIndexChanged" RepeatDirection="Horizontal">
                            </asp:RadioButtonList>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="想喝" />
                            <asp:DataList ID="DataList2" runat="server" CellPadding="4" DataSourceID="SqlDataSource6" ForeColor="#333333" OnSelectedIndexChanged="DataList2_SelectedIndexChanged" RepeatDirection="Horizontal">
                                <AlternatingItemStyle BackColor="White" />
                                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                <ItemStyle BackColor="#EFF3FB" />
